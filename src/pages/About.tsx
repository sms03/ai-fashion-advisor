      ...
      <div className="container mx-auto px-4 pt-24 pb-24">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <section className="text-center space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold text-fashion-text">
              About Our AI Fashion Advisor
            </h1>
            <p className="text-xl text-fashion-muted max-w-2xl mx-auto">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-white/50 backdrop-blur-sm p-6 rounded-xl space-y-4"
              >
          ...
          {/* How It Works */}
          <section className="bg-white/50 backdrop-blur-sm p-8 rounded-xl space-y-6">
            <h2 className="text-2xl font-semibold text-fashion-text text-center">How It Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <h3 className="font-semibold text-fashion-text">Upload Your Style</h3>
                <p className="text-fashion-muted">Share your current outfits or style preferences</p>
              </div>
              <div className="text-center space-y-4">
                ...
                <h3 className="font-semibold text-fashion-text">AI Analysis</h3>
                <p className="text-fashion-muted">Our AI analyzes your style and preferences</p>
              </div>
              <div className="text-center space-y-4">
                ...
                <h3 className="font-semibold text-fashion-text">Get Recommendations</h3>
                <p className="text-fashion-muted">Receive personalized fashion advice and trends</p>
              </div>
            </div>
          </section>
        </div>
